...
3. PROVEN DEMAND + BETTER EXECUTION: Instead of inventing something entirely new, the idea MUST be based on an existing tool or concept that is ALREADY making money in the Amazon ecosystem. The core functionality must be extremely simple and easy for a solo developer to clone. You must take this easily-clonable concept and make it slightly better (e.g., vastly superior user interface, one killer missing feature, or better pricing) to easily capture market share and start making money immediately.
