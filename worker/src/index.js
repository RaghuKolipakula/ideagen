...
3. PROVEN DEMAND + BETTER EXECUTION: Instead of inventing something entirely new, the idea MUST be based on an existing tool or concept that is ALREADY making money in the Amazon ecosystem. The core functionality MUST be extremely simple and 100% cloneable by an AI coding assistant like Gemini Antigravity (no proprietary hardware, heavy 3D rendering, or massive complex microservices). You must take this AI-cloneable concept and make it slightly better (e.g., vastly superior user interface, one killer missing feature, or better pricing) to easily capture market share and start making money immediately.
